...
export const RestaurantSidebar = () => {
  ...
  return (
    <>
      ...
      />
      <aside className={`sidebar restaurant-sidebar ${isOpen ? 'open' : ''}`}>
      <div className="sidebar-header">
        ...
        <div className="sidebar-user-info">
          ...
          <div className="sidebar-user-details">
            <div className="sidebar-user-name">{user?.fullName || 'Restaurante'}</div>
            <div className="sidebar-user-role">Mi Restaurante</div>
          </div>
        </div>
      </div>
